...
<style>
  ...
  .order-table thead tr {
    border-bottom: 2px solid rgba(201,132,138,0.15);
  }
  ...
  .grand-total-row td {
    ...
    background: rgba(201,132,138,0.05);
    border-top: 2px solid rgba(201,132,138,0.15) !important;
  ...
  .notice-banner .notice-icon { font-size: 1rem; }
  ...
  .field-group input.form-control::placeholder { color: var(--text-soft); font-weight: 300; }
  ...
  .field-group input[readonly] {
    background: rgba(201,132,138,0.05) !important;
  ...
  .btn-cancel {
    ...
    color: #c0504d;
    border: 1px solid rgba(192,80,77,0.28);
    border-radius: 4px;
    font-family: 'Jost', sans-serif;
    font-size: 0.8rem;
    font-weight: 500;
            ...
            <table class="order-table">
              ...
              <tbody>
                ...
                <tr class="grand-total-row">
                  <td colspan="5">Grand Total &nbsp;=&nbsp; Rp <?= number_format($hasil); ?></td>
                </tr>
              </tbody>
            </table>
          </div>
      ...
      <div class="card-body-inner">
        <form action="proses/order.php" method="POST">
          ...
          <div class="btn-group-checkout">
            ...
            <a href="keranjang.php" class="btn-cancel">✕ Cancel</a>
          </div>
